  ...
  return (
    <div className='flex flex-col items-center   min-h-screen    lg:w-[50vw] w-full  pb-10 '>
      <h1 className='text-2xl font-semibold  text-center'>
        ...
        {jobs.map(job => (
          <div key={job.id} className='flex flex-col   mt-6 w-[90%] md:w-[50vw] bg-white rounded-md border border-gray-200  p-6'>
            ...
            <div className='lg:flex-row flex flex-col justify-end mt-4 gap-3  text-sm'>
              <button className=' p-3  flex justify-center  gap-1     bg-green-100 hover:bg-green-50  text-green-700 rounded-md shadow-md transition-all duration-300'>
                <svg
