    ...
    return (
      <div className="flex">
        ...
        <div
          ...
          ${isOpen ? 'block' : 'hidden'} sm:block transition-all ease-in-out duration-300`}
        >
          <ul className="space-y-4 p-6">
            <li>
              <button  onClick={()=>setActiveComponent('PersonalDetails')}className="flex items-center text-lg hover:text-gray-300">
