...
const Footer = () => {
  return (
    <>
      <div
        className='lg:h-[40vh] bg-gradient-to-b from-violet-950 to-black   text-white font-poppins flex flex-col lg:flex  items-center lg:mt-20 p-8 lg:p-0 justify-center'
        id='contact'
      >
