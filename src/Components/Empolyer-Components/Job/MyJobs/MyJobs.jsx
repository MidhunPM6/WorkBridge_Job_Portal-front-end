...
const MyJobs = () => {
  ...
  const { update, deleteJob, getDesignationData, getMyJobs } = useJob()
  ...
  return (
    <div className='flex flex-col items-center   min-h-screen    lg:w-[50vw] w-full  pb-10 '>
          ...
          >
            ...
            <div className='lg:flex-row flex flex-col justify-end mt-4 gap-3  text-sm'>
              <button
                ...
                className=' p-3  flex justify-center  gap-1 bg-violet-900 text-white hover:text-gray-200 rounded-md shadow-md transition-all duration-300'
              >
                <svg
                  ...
                  viewBox='0 0 50 50'
                  fill='currentColor'
                  className='size-5 text-white hover:text-gray-200 font-semibold hover:scale-110 transition-all duration-300'
                >
              ...
              <button
                ...
                className='flex gap-1  text-red-600 p-3 justify-center  hover:text-red-700 font-semibold hover:scale-110 transition-all duration-500'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  x='0px'
                  ...
                  viewBox='0 0 50 50'
                  fill='currentColor'
                  className='size-5 text-red-600 hover:text-red-700 font-semibold hover:scale-110 transition-all duration-300'
                >
      ...
      {isDeleteModelOpen && (
        <DeleteJobModal setDeleteModelOpen={setDeleteModelOpen} jobId={jobId} />
      )}
    </div>
  )
}
