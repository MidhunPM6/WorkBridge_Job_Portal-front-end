...
const Footer = () => {
  return (
    <>
    <div className="bg-white border-t border-gray-200 px-6 py-16" id="employer-footer">
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12">
    ...
    <div className="lg:col-span-2 space-y-4">
      <div className="flex items-center">
        <svg className="w-8 h-8 text-indigo-600" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 2L4 8v12h16V8L12 2zm0 2.5L18 8v2h-6V4.5zm0 5H18v9H6v-9h6z"/>
        </svg>
        <span className="ml-2 text-2xl font-bold text-gray-900">WorkBridge</span>
      </div>
    ...
    <div>
      ...
      <ul className="space-y-3">
        <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">Talent Sourcing</a></li>
        <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">Candidate Matching</a></li>
        <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">Interview Scheduling</a></li>
        <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">Employer Branding</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul className="space-y-3">
        ...
        <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">GDPR</a></li>
      </ul>
    </div>
  ...
  <div className="mt-16 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
    <p className="text-sm text-gray-500">
      © 2025 WorkBridge Technologies. All rights reserved.
    </p>
