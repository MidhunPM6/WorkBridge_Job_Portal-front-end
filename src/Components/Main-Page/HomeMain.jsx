...
const HomeMain = () => {
  ...
  <div className='flex flex-col items-center mx-6 lg:mx-24 lg:w-[70vh] h-auto lg:h-96 space-y-2 font-poppins mt-20 lg:mt-15'>
    ...
    : 
    <div>
    <button onClick={()=>navigate('/employer')}className='lg:p-2 p-4 lg:mr-6 lg:ml-2  bg-violet-600 lg:py-2 lg:px-6 text-white rounded-md shadow-md  '>Employer</button>
    ...
    <div class="bg-violet-500 h-[1px] w-0 group-hover:w-full transition-all duration-500"></div>
    </button>
  </div>
} 
    </div>
