...
const NavBar = () => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row justify-around items-center p-6 border-b-2 border-gray-200 h-auto lg:h-20 lg:sticky top-0 z-50 bg-white ">
  ...
  <div className="  flex flex-row py-1 mr-4  ">
  {
 userDetails &&
    <button onClick={()=>navigate('/profile')} className="flex flex-row mr-2  py-2 px-2  shadow-lg rounded-md hover:scale-105 hover:transition-all hover:duration-200 lg:text-sm hover:bg-gray-100">
  ...
  <path d="M15.75 7.5c-1.376 0-2.739.057-4.086.169C10.124 7.797 9 9.103 9 10.609v4.285c0 1.507 1.128 2.814 2.67 2.94 1.243.102 2.5.157 3.768.165l2.782 2.781a.75.75 0 0 0 1.28-.53v-2.39l.33-.026c1.542-.125 2.67-1.433 2.67-2.94v-4.286c0-1.505-1.125-2.811-2.664-2.94A49.392 49.392 0 0 0 15.75 7.5Z" />
    ...
    <svg className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="Headphones-1--Streamline-Ultimate" height="24" width="24"><desc>Headphones 1 Streamline Icon: https://streamlinehq.com</desc><g id="Headphones-1--Streamline-Ultimate.svg"><path d="M6.69 13.69c-0.29 -0.18 -0.59 -0.37 -0.89 -0.59a0.5 0.5 0 0 0 -0.8 0.4v10a0.5 0.5 0 0 0 0.85 0.35c0.43 -0.43 0.82 -0.76 1.16 -1.05 0.83 -0.7 1.49 -1.25 1.49 -2.3V16c0 -1.17 -0.92 -1.75 -1.81 -2.31Z" fill="#000000" stroke-width="1"></path><path d="M22.18 13.09a0.25 0.25 0 0 1 -0.18 -0.24V10a10 10 0 0 0 -20 0v2.85a0.25 0.25 0 0 1 -0.18 0.24A2.51 2.51 0 0 0 0 15.5v6A2.5 2.5 0 0 0 2.5 24h1a0.5 0.5 0 0 0 0.5 -0.5V10a8 8 0 0 1 16 0v13.5a0.5 0.5 0 0 0 0.5 0.5h1a2.5 2.5 0 0 0 2.5 -2.5v-6a2.51 2.51 0 0 0 -1.82 -2.41Z" fill="#000000" stroke-width="1"></path><path d="M18.2 13.1c-0.3 0.22 -0.6 0.41 -0.89 0.59 -0.89 0.56 -1.81 1.14 -1.81 2.31v4.5c0 1.05 0.66 1.6 1.49 2.3 0.34 0.29 0.73 0.62 1.16 1.05a0.5 0.5 0 0 0 0.85 -0.35v-10a0.5 0.5 0 0 0 -0.8 -0.4Z" fill="#000000" stroke-width="1"></path></g></svg>
