...
const Services = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 pt-20 pb-28 max-w-4xl mx-auto text-sm">
    <div className="p-6 border-2 border-slate-300 hover:border-slate-200 flex flex-col items-center bg-white rounded-md shadow-md hover:scale-105 transition-all duration-500">
      ...
      <h1 className="pt-2 text-md scale-105 font-semibold text-center">Job Search and Filtering</h1>
      <p className="pt-2 text-center hover:text-violet-600 transition-all duration-500">
        Allows candidates to search for jobs using filters such as location,<br />
    ...
    <div className="p-6 border-2 border-slate-300 hover:border-slate-200 flex flex-col items-center bg-white rounded-md shadow-md hover:scale-105 transition-all duration-500">
      ...
      <h1 className="pt-2 text-md scale-105 font-semibold text-center">Profile and Resume Creation</h1>
      <p className="pt-2 text-center hover:text-violet-600 transition-all duration-500">
        Enables job seekers to create profiles and upload or build resumes,<br />
    ...
    <div className="p-6 border-2 border-slate-300 hover:border-slate-200 flex flex-col justify-center items-center bg-white rounded-md shadow-md transition-all duration-500 hover:scale-105">
      ...
      <h1 className="pt-2 text-md scale-105 font-semibold text-center">Skill Assessments</h1>
      <p className="pt-2 text-center   hover:text-violet-600 transition-all duration-500">
        Offers skill assessments and certification tests that candidates can<br />
        take to prove their abilities, increasing their chances of standing out<br />
        to recruiters.
      </p>
    </div>
    ...
    <div className="p-6 border-2 border-slate-300 hover:border-slate-200 flex flex-col items-center bg-white rounded-md shadow-md transition-all duration-500 hover:scale-105">
      ...
      <h1 className="pt-2 text-md scale-105 font-semibold text-center">Job Alerts and Notifications</h1>
      <p className="pt-2 text-center  hover:text-violet-600 transition-all duration-500">
        Sends personalized job alerts and notifications when relevant job<br />
    ...
    <div className="p-6 border-2 border-slate-300 hover:border-slate-200 flex flex-col items-center bg-white rounded-md shadow-md transition-all duration-500 hover:scale-105">
      ...
      <h1 className="pt-2 text-md scale-105 font-semibold text-center">Application Tracking</h1>
      <p className="pt-2 text-center hover:text-violet-600 transition-all duration-500">
        Allows job seekers to track the status of their applications,<br />
    ...
    <div className="p-6 border-2 border-slate-300 hover:border-slate-200 flex flex-col items-center bg-white rounded-md shadow-md transition-all duration-500 hover:scale-105">
      ...
      <h1 className="pt-2 text-md scale-105 font-semibold text-center">Career Guidance and Resources</h1>
      <p className="pt-2 text-center hover:text-violet-600 transition-all duration-500">
        Provides resources such as resume-writing tips, interview preparation<br />
        guides, career advice, and industry trends to help job seekers<br />
