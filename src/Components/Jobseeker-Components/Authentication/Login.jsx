    ...
    <>
      <div className='lg:flex lg:flex-row flex flex-col  min-h-screen  justify-center     '>
        <ToastContainer
          ...
          theme='dark'
        />
        <div className='flex flex-col justify-around items-center  p-7 lg:w-full bg-gradient-to-b from-violet-950 to-black shadow-2xl'>
        ...
        <div className='lg:w-[55vw]   lg:flex flex-col justify-center items-center lg:pt-0 pt-4 bg-slate-50 '>
