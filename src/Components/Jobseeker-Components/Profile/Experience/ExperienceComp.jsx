...
const ExperienceComp = () => {
  ...
  <div className='relative flex-col lg:justify-normal justify-center lg:p-16 p-8 lg:h-auto rounded-t-sm shadow-[0px_0px_10px_0px_rgba(0,0,0,0.08)] w-full'>
    <Toaster />
    {/* Header with better contrast and explicit action label */}
    <div className='flex justify-between p-3 items-center bg-violet-100 text-violet-700 h-16 rounded-sm'>
