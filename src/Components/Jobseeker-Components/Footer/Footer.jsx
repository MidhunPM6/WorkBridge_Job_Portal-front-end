...
const Footer = () => {
  return (
    <>
      <div
        className='lg:h-[40vh] bg-slate-900  text-white font-poppins flex flex-col lg:flex  items-center lg:mt-0 p-8 lg:p-0 justify-center'
        id='contact'
      >
        <div className='flex flex-col items-center lg:items-center lg:mr-0 lg:pt-4'>
          <h1 className='text-4xl lg:text-4xl'>WorkBridge</h1>
          <p className='text-md pt-1 text-center '>Job Seeking Platform</p>
