...
const NavBar = () => {
  ...
  {
 userDetails &&
    <button onClick={()=>navigate('/profile')} className="flex  h-8 justify-center items-center p-2 rounded-sm shadow-lg text-sm px-4 bg-violet-900 hover:bg-violet-800 text-white">
