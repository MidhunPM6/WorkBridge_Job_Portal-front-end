      ...
      <div className='flex flex-col lg:flex-row justify-around items-center p-6 shadow-md h-auto lg:h-20 lg:sticky top-0 z-50 bg-white '>
        <div className='flex flex-col lg:flex-row  items-center w-full lg:w-auto'>
          ...
          <div className='hidden lg:flex space-x-10 ml-0 lg:ml-6 mt-4 lg:mt-0 text-gray-500 text-sm'>
            <NavHashLink
              to='/#home'
              className=' hover:text-gray-700 place-content-center hover:underline underline-offset-4 '
              smooth
            >
              Home
            </NavHashLink>
            ...
            {user?.name && (
              <div>
                <button
                  ...
                  className='flex  h-8 justify-center items-center p-2 rounded-sm shadow-lg text-sm px-4 bg-violet-900 hover:bg-violet-800 text-white'
                >
                  <svg
