...
const ProfileCoverPreview = ({
  setPreviewModalOpen,
  previewURL,
  handleProfileCoverUpload,
  profileCoverLoading,
}) => {
  return (
    <>
      ...
      >
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
          <div className='bg-white p-4 rounded-lg shadow-md flex flex-col gap-3 items-center lg:max-w-[30vw]'>
...
export default ProfileCoverPreview
