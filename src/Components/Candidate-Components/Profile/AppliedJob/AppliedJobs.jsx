   ...
   <div className=" p-6">
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="mb-10 text-center">
         ...
         <p className='text-gray-600 mb-4'>Here you can see all the jobs you have applied for. Track your application status and stay updated.</p>
        </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <h3 className="font-semibold text-lg">{job.jobId.title}</h3>
                      <p className="text-gray-500 text-sm">{job.jobId.location}</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center text-gray-500 mb-4 text-sm">
                  ...
                  <span> {format(new Date(job.jobId.updatedAt), 'MMM dd')}</span>
                </div>
